                    ...
                    <div class="single-product">
                        <div class="product-f-image">
                            ...
                            <div class="product-hover">
                                <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Compra/r</a>
                        ...
                        <div class="product-carousel-price">
                            <ins>R$ <?php echo formatPrice($value1["vlprice"]); ?></ins> <!--<del>$100.00</del> QUANDO TIVER DESCONTO-->
                        </div> 
                    </div>
                    <?php } ?>
                </div>
